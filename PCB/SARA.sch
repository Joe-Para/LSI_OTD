...
<packages>
<package name="ZSFP+">
<smd name="1" x="-3.6" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="2" x="-2.8" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="3" x="-2" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="4" x="-1.2" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="5" x="-0.4" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="6" x="0.4" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="7" x="1.2" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="8" x="2" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="9" x="2.8" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="10" x="3.6" y="-4.1" dx="0.5" dy="2" layer="1"/>
<smd name="11" x="3.6" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="12" x="2.8" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="13" x="2" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="14" x="1.2" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="15" x="0.4" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="16" x="-0.4" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="17" x="-1.2" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="18" x="-2" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="19" x="-2.8" y="4.1" dx="0.5" dy="2" layer="1"/>
<smd name="20" x="-3.6" y="4.1" dx="0.5" dy="2" layer="1"/>
<hole x="-5" y="0" drill="1.6"/>
<hole x="4.6" y="0" drill="1.6"/>
<wire x1="-3" y1="7" x2="-3" y2="11" width="0.127" layer="21"/>
<wire x1="-3" y1="11" x2="3" y2="11" width="0.127" layer="21"/>
<wire x1="3" y1="11" x2="3" y2="7" width="0.127" layer="21"/>
<wire x1="3" y1="7" x2="-3" y2="7" width="0.127" layer="21"/>
<circle x="-5" y="-7" radius="0.5" width="1" layer="21"/>
</package>
</packages>
<symbols>
<symbol name="ZSFP+">
<pin name="GND_1" x="-20.32" y="22.86" length="middle" direction="pwr"/>
<pin name="TX_FAULT" x="-20.32" y="17.78" length="middle"/>
<pin name="TX_DISABLE" x="-20.32" y="12.7" length="middle"/>
<pin name="SDA" x="-20.32" y="7.62" length="middle"/>
<pin name="SCL" x="-20.32" y="2.54" length="middle"/>
<pin name="MOD-ABS" x="-20.32" y="-2.54" length="middle"/>
<pin name="RS0" x="-20.32" y="-7.62" length="middle"/>
<pin name="RX_LOS" x="-20.32" y="-12.7" length="middle"/>
<pin name="RS1" x="-20.32" y="-17.78" length="middle"/>
<pin name="GND_2" x="-20.32" y="-22.86" length="middle" direction="pwr"/>
<pin name="GND_3" x="22.86" y="-22.86" length="middle" direction="pwr" rot="R180"/>
<pin name="RD-" x="22.86" y="-17.78" length="middle" rot="R180"/>
<pin name="RD+" x="22.86" y="-12.7" length="middle" rot="R180"/>
<pin name="GND_4" x="22.86" y="-7.62" length="middle" direction="pwr" rot="R180"/>
<pin name="VCCR" x="22.86" y="-2.54" length="middle" direction="pwr" rot="R180"/>
<pin name="VCCT" x="22.86" y="2.54" length="middle" direction="pwr" rot="R180"/>
<pin name="GND_5" x="22.86" y="7.62" length="middle" direction="pwr" rot="R180"/>
<pin name="TD+" x="22.86" y="12.7" length="middle" rot="R180"/>
<pin name="TD-" x="22.86" y="17.78" length="middle" rot="R180"/>
<pin name="GND_6" x="22.86" y="22.86" length="middle" direction="pwr" rot="R180"/>
...
<text x="-2.54" y="30.48" size="1.27" layer="94">zSFP+</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="ZSFP+">
<gates>
<gate name="G$1" symbol="ZSFP+" x="0" y="0"/>
</gates>
<devices>
<device name="" package="ZSFP+">
<connects>
...
<connect gate="G$1" pin="GND_6" pad="20"/>
<connect gate="G$1" pin="MOD-ABS" pad="6"/>
<connect gate="G$1" pin="RD+" pad="13"/>
<connect gate="G$1" pin="RD-" pad="12"/>
<connect gate="G$1" pin="RS0" pad="7"/>
<connect gate="G$1" pin="RS1" pad="9"/>
<connect gate="G$1" pin="RX_LOS" pad="8"/>
...
<attribute name="VALUE" x="206.375" y="34.925" size="1.778" layer="96"/>
</instance>
...
<instance part="JP12" gate="G$1" x="144.78" y="40.64" smashed="yes" rot="R180">
<attribute name="NAME" x="151.13" y="37.465" size="1.778" layer="95" rot="R180"/>
<attribute name="VALUE" x="151.13" y="45.72" size="1.778" layer="96" rot="R180"/>
</instance>
